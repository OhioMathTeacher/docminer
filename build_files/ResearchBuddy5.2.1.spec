...
# PyInstaller spec file for ResearchBuddy 5.2.1 - OPTIMIZED BUILD
# Excludes unnecessary ML/scientific libraries to reduce size
# CRITICAL FIXES: AI environment variables, size optimization
